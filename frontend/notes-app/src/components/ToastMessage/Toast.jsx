...
const Toast = ({ isShown, message, type, onClose }) => {
  ...
  return (
    <div
    className={`absolute top-20 right-6 transition-all duration-300 ${isShown ? "opacity-100" : "opacity-0"}`}>
      <div 
        ...
        <div className='flex items-center gap-3 py-2 px-4'>
          <div className={`w-10 h-10 flex items-center justify-center rounded-full ${type === "delete" ? "bg-red-50"
            : "bg-green-50"}`}>
